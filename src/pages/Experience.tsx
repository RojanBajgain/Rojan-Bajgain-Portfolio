...
import { ArrowRight, BadgeCheck, Briefcase, Calendar, GraduationCap } from "lucide-react";
    ...
    <div className="min-h-[85vh] px-6">
      <div className="max-w-7xl mx-auto pt-12">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-3xl md:text-4xl font-bold mb-6 fade-in">Work Experience</h1>
          ...
          <div className="mt-8 space-y-12 slide-in-bottom">
            <div className="relative">
              ...
              <div className="relative pl-10 mb-12">
                ...
                <div className="space-y-8">
                  <div className="bg-secondary/30 p-6 rounded-xl">
                    <h3 className="text-lg font-medium mb-3">Attendance Management System (AMS)</h3>
              ...
              <div className="relative pl-10 mb-12">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between mb-2">
                  <h2 className="text-xl font-semibold">Flutter Development Intern</h2>
                  <div className="flex items-center gap-1.5 text-sm text-muted-foreground">
                    <Calendar className="w-4 h-4" />
                ...
                <p className="text-lg mb-4">TechHub Nepal, Kathmandu</p>
                
                <div className="bg-secondary/30 p-6 rounded-xl">
                  <h3 className="text-lg font-medium mb-3">Learning & Development</h3>
                  <ul className="space-y-2">
                    {[
            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="bg-secondary/30 p-6 rounded-xl">
                  <div className="flex flex-col md:flex-row md:items-center justify-between mb-2">
                    <h3 className="text-lg font-medium">BCA – Bachelor of Computer Application</h3>
                    <div className="flex items-center gap-1.5 text-sm text-muted-foreground">
                      <Calendar className="w-4 h-4" />
                ...
                <div className="bg-secondary/30 p-6 rounded-xl">
                  <div className="flex flex-col md:flex-row md:items-center justify-between mb-2">
                    <h3 className="text-lg font-medium">Higher Secondary Education (Science)</h3>
                    <div className="flex items-center gap-1.5 text-sm text-muted-foreground">
                      <Calendar className="w-4 h-4" />
                      <span>2017 - 2020</span>
                    </div>
